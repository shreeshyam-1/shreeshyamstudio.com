        ...
        <><nav className="shadow-md w-screen fixed top-0 bg-[#ffffffed] z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ">
                <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    {/* <Image height={160} width={160} src="/images/logo.png" className="h-16 w-auto" alt="Singhal Sanitary and Hardware store logo" /> */}

                    <span className="self-center text-2xl  whitespace-nowrap text-[#988413]">Shree Shyam Studio</span>
                </Link>
